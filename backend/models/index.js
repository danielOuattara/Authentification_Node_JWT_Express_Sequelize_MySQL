...
We use User.belongsToMany(Role) to indicate that the user model can 
belong to many Roles and vice versa.

With 'through', 'foreignKey', 'otherKey', we’re gonna have a new table "user_roles" 
as connection between users and roles table via their 
primary key as foreign keys.   
